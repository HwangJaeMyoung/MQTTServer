...
from django.contrib import admin
from .models import Location, Plug_type, Plug, Device_type, Device, Sensor_type, Sensor, Sensor_networking, Sensor_value, Sensor_value_file
...
@admin.register(Plug_type)
class PlugTypeAdmin(admin.ModelAdmin):
    list_display = ('name', 'model', 'wifi', 'admin_email')
    search_fields = ('name', 'model')
    list_filter = ('wifi',)

@admin.register(Plug)
class PlugAdmin(admin.ModelAdmin):
    list_display = ('name', 'location', 'plug_type', 'status', 'plug_status', 'ip_address', 'created_at')
    search_fields = ('name',)
    list_filter = ('status', 'plug_status')

@admin.register(Device_type)
class DeviceTypeAdmin(admin.ModelAdmin):
    list_display = ('name', 'model', 'wifi', 'created_at')
    search_fields = ('name', 'model')
    list_filter = ('wifi',)

@admin.register(Device)
class DeviceAdmin(admin.ModelAdmin):
    list_display = ('name', 'location', 'plug', 'status', 'ip_address', 'created_at')
    search_fields = ('name',)
    list_filter = ('status',)

@admin.register(Sensor_type)
class SensorTypeAdmin(admin.ModelAdmin):
    list_display = ('name', 'model', 'properties')
    search_fields = ('name', 'model')

@admin.register(Sensor)
class SensorAdmin(admin.ModelAdmin):
    list_display = ('name', 'attached_device', 'collecting_device', 'attention')
    search_fields = ('name',)
    list_filter = ('attention',)

@admin.register(Sensor_networking)
class SensorNetworkingAdmin(admin.ModelAdmin):
    list_display = ('sensor', 'device', 'topic', 'action_type', 'direction', 'status', 'network_status', 'timestamp')
    list_filter = ('status', 'network_status', 'direction')

@admin.register(Sensor_value)
class SensorValueAdmin(admin.ModelAdmin):
    list_display = ('sensor', 'device', 'value_type', 'value', 'timestamp')
    list_filter = ('sensor', 'device', 'value_type')

@admin.register(Sensor_value_file)
class SensorValueFileAdmin(admin.ModelAdmin):
    list_display = ('device', 'sensor', 'value_type', 'timestamp', 'file')
    list_filter = ('device', 'sensor', 'value_type')
